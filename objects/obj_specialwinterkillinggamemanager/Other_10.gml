if !hasloaded
{
	count=instance_number(obj_gijinka_winterp1nes)
	hasloaded = true
}
else
{
	...
	if wincondition && global.GAME_STATE = "normal" //array_length(to_catch)<=0 && global.GAME_STATE = "normal"
	{
		...
		var _winpostarget = instance_create_depth(room_width*0.5,room_height*0.5,0,obj_null)
			...
			for(var _i = 0; _i<instance_number(obj_gijinka_crepuscule); _i++)
			{
				var _winners = instance_find(obj_gijinka_crepuscule,_i)

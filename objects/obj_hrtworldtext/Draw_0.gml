...
with(obj_mapparent) {
	if(!scr_compare(object_get_parent(self.object_index),obj_pictureobstacleparent, obj_lockparent, obj_gate, obj_gate_classic, obj_pinball)) draw_sprite(self.sprite_index,-1,0,0);
}

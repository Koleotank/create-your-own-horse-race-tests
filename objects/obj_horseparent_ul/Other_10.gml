...
var _collidables = [obj_mapparent,obj_horseparent_ul]
...
if place_meeting(x,y,obj_horseparent_ul)
{
	//show_debug_message("stuck inside horse, performing anti collision clip")
	func_anticollisionclipping(obj_horseparent_ul)
}
...
if place_meeting(x+sign(hsp),y+sign(vsp),obj_horseparent_ul)
{
	var _collidingobject = instance_place(x+sign(hsp),y+sign(vsp),obj_horseparent_ul)
	func_performknockback(_collidingobject)
}

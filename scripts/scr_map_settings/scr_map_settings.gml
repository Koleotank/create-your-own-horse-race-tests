function scr_map_settings(argument0)
{
	...
	switch argument0
	{
		...
		case rm_gijinka62:
		{
			func_switchmusic(sfx_mu_mmbn6surge)
			global.SHOW_TIMER = false
			global.ANTI_COLLISION_MEASURE = "expensive"
			//global.COUNTDOWN_SKIPTO = 419
			//global.REMAINING_WIN_SLOTS = 75
		...
		case rm_gijinka61b:
		{
			func_switchmusic(sfx_mu_mmbn6promise)
			global.SHOW_TIMER = false
			global.ANTI_COLLISION_MEASURE = "expensive"
			global.OUT_OF_BOUNDS_MEASURE = "wrap"
			//global.COUNTDOWN_SKIPTO = 419
		...
		case rm_gijinka63:
		{
			func_switchmusic(sfx_mu_kot_pull)
			global.SHOW_TIMER = false
			global.ANTI_COLLISION_MEASURE = "expensive"
			//global.COUNTDOWN_SKIPTO = 419
			//global.REMAINING_WIN_SLOTS = 75
		...
		case rm_gijinka66:
		{
			func_switchmusic(sfx_mu_ej1000counter)
			global.SHOW_TIMER = false
			global.ANTI_COLLISION_MEASURE = "expensive"
			global.OUT_OF_BOUNDS_MEASURE = "wrap"
			//global.COUNTDOWN_SKIPTO = 419
		...
		case rm_gijinka67:
		{
			func_switchmusic(sfx_mu_brandish2gado)
			global.SHOW_TIMER = false
			global.ANTI_COLLISION_MEASURE = "expensive"
			//global.COUNTDOWN_SKIPTO = 419
			//global.REMAINING_WIN_SLOTS = 75
